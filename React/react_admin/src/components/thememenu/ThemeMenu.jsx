...
const ThemeMenu = () => {
  ...
  const menu_toggle_ref = useRef = useRef(null)
  ...
  const setColor = color => {
    ...
    localStorage.setItem('themeMode', color.class)
    dispatch(ThemeAction.setAction.setColor(color.class))
  }

  useEffect(() => {
    const themeClass = mode_settings.find(e => e.class === localStorage.getItem('themeMode', 'theme_mode-light'))
