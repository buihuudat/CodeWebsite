    ...
    if (type === 'channel') {
        return (
            ...
            onClick={() => {
                ...
                className={focusedId === channel.id ? 'channel-search__result-container__focused' : 'channel-search_result-container'}
            >
    ...
    return (
        ...
        >
            <div className='channel-search__result-user'>
                ...
                <p className='channel-search__result__text'>{channel.name}</p>
            </div>
        </div>
    );
};
